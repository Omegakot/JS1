...
//     constructor(name,price2,price4){
//         super(name)
//         this.price2=price2
//         this.price4=price4
...
// let item2 = new Vegetables("Капуста",1222,12)
// console.log(item1)
// console.log(item2)
...
sayHiq(){
    console.log("Привет,лет")
}
}
let z= new Moto("Вася",30)
console.log(z)
...
console.log(writer.age2)
console.log(writer.www)
